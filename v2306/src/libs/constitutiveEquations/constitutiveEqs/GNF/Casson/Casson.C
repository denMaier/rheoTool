...
:
    ...
    etaMin_(reg_ == false ? dict.get<dimensionedScalar>("etaMin") : dimensionedScalar("1",dimPressure*dimTime,1.)),
    etaMax_(reg_ == false ? dict.get<dimensionedScalar>("etaMax") : dimensionedScalar("1",dimPressure*dimTime,1.)),
    m_(reg_ == true ? dict.get<dimensionedScalar>("m") : dimensionedScalar("1",dimTime,1.) ),
    tau_
    (
        IOobject
        (
